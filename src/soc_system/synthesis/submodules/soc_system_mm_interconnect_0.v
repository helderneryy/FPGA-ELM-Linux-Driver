...
module soc_system_mm_interconnect_0 (
	...
	wire          pio_signals_s1_agent_rp_valid;                                                      // pio_signals_s1_agent:rp_valid -> router_009:sink_valid
	wire  [128:0] pio_signals_s1_agent_rp_data;                                                       // pio_signals_s1_agent:rp_data -> router_009:sink_data
	wire          pio_signals_s1_agent_rp_ready;                                                      // router_009:sink_ready -> pio_signals_s1_agent:rp_ready
	wire          pio_signals_s1_agent_rp_startofpacket;                                              // pio_signals_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          pio_signals_s1_agent_rp_endofpacket;                                                // pio_signals_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire          cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> pio_signals_s1_burst_adapter:sink0_valid
	wire  [128:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> pio_signals_s1_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                                              // pio_signals_s1_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [6:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> pio_signals_s1_burst_adapter:sink0_channel
	wire          cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> pio_signals_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> pio_signals_s1_burst_adapter:sink0_endofpacket
	...
	wire    [6:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> pio_data_out_s1_burst_adapter:sink0_channel
	...
	wire          pio_signals_s1_agent_rdata_fifo_out_valid;                                          // pio_signals_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] pio_signals_s1_agent_rdata_fifo_out_data;                                           // pio_signals_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_004:in_0_data
	wire          pio_signals_s1_agent_rdata_fifo_out_ready;                                          // avalon_st_adapter_004:in_0_ready -> pio_signals_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> pio_signals_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> pio_signals_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                                  // pio_signals_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> pio_signals_s1_agent:rdata_fifo_sink_error
